...
describe("parseCode", () =>{
    test("code section from arrays.wasm", ()=>{
        const code = new Uint8Array([
            ...
            0x40, 0x20, 0x03, 0x0F, 0x0B, 0x20, 0x03, 0x20, 0x02, 0x20, 0x00, 0x10, 0x04, 0x20, 0x00, 0x41, // error
        ...
        console.log(bp.parseCode(code, 0));

    })
    // test("parseCode section from arrays.wasm  (valtype error)", ()=>{
    //     const code = new Uint8Array([0x20, 0x03, 0x20, 0x02, 0x20, 0x00, 0x10, 0x04, 0x20, 0x00, 0x41, 0x01, 
    //         0x6A, 0x20, 0x01, 0x20, 0x02, 0x41, 0x01, 0x6A, 0x20, 0x03, 0x10, 0x08, 0x0B])
